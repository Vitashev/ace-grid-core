...
export const ACE_GRID_SVELTE_DEFAULT_TAG_NAME = "ace-grid";
export const ACE_GRID_SVELTE_EVENT_PREFIX = "ace-grid-";
export const ACE_GRID_SVELTE_COMMON_EVENTS = {
...
export type AceGridSvelteCommonEventName =
  (typeof ACE_GRID_SVELTE_COMMON_EVENTS)[keyof typeof ACE_GRID_SVELTE_COMMON_EVENTS];

export type AceGridSvelteElementHost<
  TProps extends GridComponentProps = GridComponentProps,
  THookOptions = Record<string, unknown>,
  TRows = unknown,
  TActions = unknown,
...
export interface AceGridSvelteReadyEvent<
  ...
  TActions = unknown,
> {
  element: AceGridSvelteElementHost<TProps, THookOptions, TRows, TActions>;
}

export type AceGridSvelteIconTemplateRegistry = Partial<{
  [K in keyof GridIconSet]: import("svelte").Component<
...
> {
  ...
  iconTemplates?: AceGridSvelteIconTemplateRegistry | null;
  elementClassName?: string;
  _rowsTypeHint?: TRows | null;
  _actionsTypeHint?: TActions | null;
}

export interface AceGridSvelteComponentEvents<
  TProps extends GridComponentProps = Partial<GridProps>,
  THookOptions = UseGridOptions,
  TRows = GridRow[],
  TActions = GridActions,
> {
  ready: AceGridSvelteReadyEvent<TProps, THookOptions, TRows, TActions>;
...
export interface AceGridSvelteComponentExports<
  TProps extends GridComponentProps = Partial<GridProps>,
  THookOptions = UseGridOptions,
  TRows = GridRow[],
  TActions = GridActions,
> {
  getElement: () => AceGridSvelteElementHost<
    TProps,
    THookOptions,
    TRows,
    TActions
  ...
  setIconTemplates: (partial: Partial<AceGridSvelteIconTemplateRegistry>) => void;
  getIconTemplates: () => AceGridSvelteIconTemplateRegistry | null;
...
export type AceGridSvelteDefaultProps = Partial<GridProps>;
export type AceGridSvelteDefaultHookOptions = UseGridOptions;
export type AceGridSvelteDefaultRows = GridRow[];
export type AceGridSvelteDefaultActions = GridActions;
